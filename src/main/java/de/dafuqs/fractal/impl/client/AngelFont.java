...
public record AngelFont(
	...
	public record CharDef(int x, int y, int width, int height, int xOffset, int yOffset, int xAdvance, ResourceLocation page) {}
	
	public static AngelFont parse(ResourceLocation reference, BufferedReader r) throws FileNotFoundException, IOException {
		try (r) {
			...
			var pages = new Int2ObjectOpenHashMap<ResourceLocation>(parseInt(common.get("pages")));
